...
export default function PlayerProfile() {
    ...
    <div className="w-full">
        ...
        <div className="container mx-auto p-4 bg-blue-500 flex justify-center">

            <div className="w-1/2 bg-blue-900 h-600"> 
                ciao raga
            </div>

            <div className="w-1/2 bg-red-600 h-full flex flex-col justify-center items-center">
            ...
            {loading
                ...
                : playerMatches.length === 0
                    ...
                    : (playerMatches.map((match, index) => (<div key={index}
                        className="bg-defaultBg2 shadow-md rounded-lg mb-2 w-[98%]">
                        ...
                        <div className="mt-0 grid grid-cols-4 m-0 p-0 bg-white-600"> {
